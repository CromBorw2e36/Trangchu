                    ...
                    <div class="row text-start">
                        <div class="col-12 border shadow rounded-2 p-1 mb-3">
                            ...
                            <div class="p-3 pt-0">
                                <div class="d-flex justify-content-between pb-2">
                                    <input type="submit" name="savePost" value="Lưu lại">
                                    <input type="button" name="review" value="Xem trước">
                                </div>
                                <div>
                                    <div>
                                        <p>
                                ...
                                <div class="d-flex justify-content-end">
                                    <input type="submit" value="Công bố" name="Posts" class="btn btn-primary justyfi">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 p-1 rounded-2 border shadow">
                            ...
                            <ul class="list-unstyled p-3 pt-0">
                                <li class="form-check">
                                    <input class="form-check-input" type="radio" name="radioKind" value="Trích dẫn" id="radioKind">
                                    <label class="form-check-label" for="radioKind">Trích dẫn</label>
                                </li>
                                <li class="form-check">
                                    <input class="form-check-input" type="radio" name="radioKind" value="Bài viết" id="radioKind">
                                    <label class="form-check-label" for="radioKind">Bài viết</label>
                                </li>
                                <li class="form-check">
                                    <input class="form-check-input" type="radio" name="radioKind" value="Hướng dẫn" id="radioKind">
                                    <label class="form-check-label" for="radioKind">Hướng dẫn</label>
                                </li>
                                <li class="form-check">
                                    <input class="form-check-input" type="radio" name="radioKind" value="Thông tin chung" id="radioKind">
                                    <label class="form-check-label" for="radioKind">Thông tin chung</label>
                                </li>
                                <li class="form-check">
                                    <input class="form-check-input" type="radio" name="radioKind" value="Giới thiệu" id="radioKind">
